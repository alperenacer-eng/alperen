...
const Layout = () => {
  ...
  const personelMenuItems = [
    ...
    { path: '/personel-kaynaklar', icon: Database, label: 'Kaynaklar', testId: 'nav-personel-kaynaklar' },
  ];
  ...
  const parkeMenuItems = [
    { path: '/parke-uretim', icon: Factory, label: 'Parke Üretim', testId: 'nav-parke-uretim' },
    { path: '/parke-kaynaklar', icon: Database, label: 'Kaynaklar', testId: 'nav-parke-kaynaklar' },
  ];

  const irsaliyeMenuItems = [
    { path: '/irsaliye-liste', icon: List, label: 'İrsaliye Listesi', testId: 'nav-irsaliye-liste' },
  ];
  ...
  const menuItems = currentModule?.id === 'bims' 
    ...
    : currentModule?.id === 'parke'
    ? [...baseMenuItems, ...parkeMenuItems]
    : currentModule?.id === 'irsaliye'
    ? [...baseMenuItems, ...irsaliyeMenuItems]
    : baseMenuItems;
